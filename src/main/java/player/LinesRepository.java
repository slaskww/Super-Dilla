...
public class LinesRepository {
    ...
    static{
        ...
        listOfLines = new ArrayList<>(Arrays.asList(ANSI_RED + "Jak tam biznes? Slyszalem, ze idzie popyt na " + DrugType.COCAINE.name() + ". Lepiej zrobic male zapasy." + ANSI_RESET,
                ...
                ANSI_RED + "Slyszales moze o dobrym skladziku z bronia? Podobno stukasz 997 i jestes w albanskim raju."+ ANSI_RESET,
                ...
                ANSI_RED + "Skoncz juz ganiac z ta zdzawa pala. Zakup jakas szacowna bron i pokaz sie miastu. Stukaj 997 i wkraczaj po sprzet."+ ANSI_RESET
                ));
    }
